...
// declarations
extern "C" {
SEXP determinant_c( SEXP SS, SEXP Mcast, SEXP Acast, SEXP Bcast, SEXP Ccast, SEXP patternCast, SEXP ineq, SEXP samples, SEXP mConst) ;
}
...
const int cc = Rcpp::as<int>(mConst);
//Rcout << "Ineq:\n"<<"\n";
