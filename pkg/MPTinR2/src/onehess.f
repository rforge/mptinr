...
c       call first(mix,pj,m1)
 ...
 200   continue
   	   ...
   	   errout=10
	open(errout,file='onehess.err')
		write(errout,*) (kerncat)
		write(errout,*) (kernpar)
		write(errout,*) (zweig)
   		write(errout,*) (trees)
		write(errout,*) (indi)		
		write(errout,*) (A(i,1,1),i=1,kerncat)
		write(errout,*) (B(i,1,1),i=1,kerncat)
		write(errout,*) (branch(i),i=1,kerncat)
		write(errout,*) (C(i,1),i=1,kerncat)
		write(errout,*) (iDaten(1,i),i=1,kerncat)
		write(errout,*) (noc(i),i=1,kernpar)
		write(errout,*) (x(i),i=1,kernpar)
		write(errout,*) (hess(1,i),i=1,kernpar+1)
	    write(errout,*) (hess(2,i),i=1,kernpar+1)
	    write(errout,*) (ifail)
	    write(errout,*) (ntotal)
	    write(errout,*) (n)
	    write(errout,*) (catno)
c	   write(errout,*) (npers)
	   write(errout,*) (eparno)
	   write(errout,*) (h(1,i),i=1,kernpar+1)
	   write(errout,*) (h(2,i),i=1,kernpar+1)
	   close(10)
